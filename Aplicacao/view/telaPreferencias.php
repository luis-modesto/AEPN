...
<?php
 ...
 echo '           <div class = "container mt-3 container-geral">
                <h3> Cadastrar Preferências Alimentares </h3>
                <div class = "row">
                    <form action = "./telaPreferencias.php" class= "col-12 mt-5 form-inline" method = "post">
    ...
    echo'        </div>
            ...
            <button type = "button" data-toggle = "modal" data-target = "#preferenciasAtuais" class = "offset-1 mt-3 mb-3 btn btn-primary"> Ver Preferências </button> 
            <button type = "button" onclick = "irIntolerancias();" class = "offset-8 mt-3 mb-3 btn btn-info"> Continuar </button> 
            <form action = "telaPreferencias.php" style = "display: none" id = "alimentosEscolhidos" method = "post">
            </form>';
    echo'    <div class="modal fade" role="dialog" id="preferenciasAtuais">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"> Preferencias de ' .$paciente->nome . '</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <ul class="list-group" style = "max-height: 250px; overflow-y: scroll;">';
                    for($i=0; $i<count($preferencias); $i++){
                        echo '<li class = "list-group-item">' . $preferencias[$i]->nome . ' </li>';
                    }
