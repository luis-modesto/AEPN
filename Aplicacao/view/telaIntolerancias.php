...
<?php
 ...
 echo '           <div class = "container mt-3 container-geral">
                <h3> Cadastrar Intolerâncias Alimentares </h3>
                <div class = "row">
                    <form action = "./telaIntolerancias.php" class= "col-12 mt-5 form-inline" method = "post">
    ...
    echo'        </div>
            ...
            <button type = "button" data-toggle = "modal" data-target = "#intoleranciasAtuais" class = "offset-1 mt-3 mb-3 btn btn-primary"> Ver Intolerâncias </button> 
            <button type = "button" onclick = "irSuplementos();" class = "offset-8 mt-3 mb-3 btn btn-info"> Continuar </button> 
            <form action = "telaIntolerancias.php" style = "display: none" id = "alimentosEscolhidos" method = "post">
            </form>';
    echo'    <div class="modal fade" role="dialog" id="intoleranciasAtuais">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"> Intolerâncias de ' .$paciente->nome . '</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <ul class="list-group" style = "max-height: 250px; overflow-y: scroll;">';
                    for($i=0; $i<count($intolerancias); $i++){
                        echo '<li class = "list-group-item">' . $intolerancias[$i]->nome . ' </li>';
                    }
